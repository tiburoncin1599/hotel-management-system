...
export function CancelBookingDialog({ bookingId, onClose }: CancelDialogProps) {
    ...
    >
      ...
      >
        ...
        <p className="mt-4 text-sm text-gray-500">
          ¿Estás seguro de cancelar esta reserva? Esta acción registrará la cancelación en el
